...
This file has been taken from RAVE for RB52ODIM.
...
------------------------------------------------------------------------*/
/**
 * Python compability file for making it possible to compile rb52odim for both Python >2.6 and Python3
 * @file
...
#ifndef PYRB52ODIMCOMPAT_H
#define PYRB52ODIMCOMPAT_H
...
#define PY_COMPARE_ATTRO_NAME_WITH_STRING(ptr, name) PyRB52ODIMAPI_CompareWithASCIIString(ptr, name)

#define PY_COMPARE_STRING_WITH_ATTRO_NAME(name, ptr) PyRB52ODIMAPI_CompareWithASCIIString(ptr, name)
 ...
 * @return 0, -1 or 1
 */
static int PyRB52ODIMAPI_CompareWithASCIIString(PyObject* ptr, const char* name) {
  int result = -1;
