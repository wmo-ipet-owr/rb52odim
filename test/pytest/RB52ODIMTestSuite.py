...
#  suite.addTest(rb52odimTest("testIsBadRB5Input"))
#  suite.addTest(rb52odimTest("testIsGoodRB5Input"))
#  suite.addTest(rb52odimTest("testIsGoodRB5gzInput"))
#  suite.addTest(rb52odimTest("testModuleReadRB5Corrupt"))
#  suite.addTest(rb52odimTest("testSingleRB5Corrupt"))
#  suite.addTest(rb52odimTest("testReadRB5Corrupt"))
#  suite.addTest(rb52odimTest("testReadRB5Azi"))
...
#  suite.addTest(rb52odimTest("testCombineRB5FromTarballReturnRIO"))
#  suite.addTest(rb52odimTest("testMergeOdimScans2Pvol"))
#  suite.addTest(rb52odimTest("testCombineRB5Tarballs2Pvol"))
#  suite.addTest(rb52odimTest("testGunzip"))
#  suite.addTest(rb52odimTest("testRoundDT"))
...
#  suite.addTest(rb52odimTest("testReadRB5"))
#  suite.addTest(rb52odimTest("testReadRB5NotAList"))
